class Counter(dict):
    ...
    It is specialized to have number values (integers or floats),
    and includes a handful of additional functions to ease the task of counting data.
    In particular, all keys are defaulted to have value 0.
    ...
    The counter also includes additional functionality useful for assignments.
    Two counters can be added, subtracted, or multiplied together.
    They can also be normalized and their total count and arg max can be extracted.
    """
